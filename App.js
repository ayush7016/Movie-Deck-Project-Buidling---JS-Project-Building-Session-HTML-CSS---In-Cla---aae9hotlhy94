...
async function showMovies(pageNumber = 1, sort_by = "desc") {
  ...
  const options = {
    ...
    headers: {
      ...
      Authorization: 'Bearer eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiIyYzNhOTQzOGE1ZGVjNjE2NjMxMDZiYjQ5ZTRlZWU3YiIsInN1YiI6IjY0ZDUwNzZjYmYzMWYyMDFjYThhY2ZkNiIsInNjb3BlcyI6WyJhcGlfcmVhZCJdLCJ2ZXJzaW9uIjoxfQ.bu6lNuG4Q6QIqa4t9-_jrbsNqEEzfZN_pnRUzhqtm5w'
    },
  };
  let response;
